...
<head>
    ...
    <body>
        <div class="container card">
            ...
            <hr>
            <span class="text-center"> <strong> IRON STUDY</strong>
            </span>
            <hr>
        </div>
    </body>
    ...
    <tr>
      ...
      <td>Adult : 60 - 150 ug / dl</td>      
    </tr>
    <tr>
      <td>Sr. Ferritin</td>
      <td><input type="TEXT" name="number" value=""></td>
      <td>Male : 18 - 370 ng / ml<br>
          Female : 9 - 120 ng / ml</td>      
    </tr>
    <tr>
