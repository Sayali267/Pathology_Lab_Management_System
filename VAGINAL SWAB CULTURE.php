<html>
<title>VAGINAL SWAB CULTURE </title>
<html>
    <head>
    ...
    <body>
        <div class="container card">
            ...
            <hr>
            <span class="text-center"> <strong>VAGINAL SWAB CULTURE </strong>
            </span>
            <hr>
    ...
    <tr>
      ...
      <td> <textarea name="message" rows="4" cols="15"></textarea></td>
        ...
        <table class="name">
            <border align="left">
                <h5>MACROSCOPIC EXAMINATION</h5></border>
        <tr>
            <td>RESULT</td>
            <td><textarea name="message" rows="4" cols="15"></textarea></td>
